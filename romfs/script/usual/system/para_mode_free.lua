...
function groundStart()
  ...
  if FLAG.ParaMultiPlay == CONST.FLAG_TRUE and FLAG.MapFlags == CONST.MAP_PARA_CENTER and FLAG.MapFrom == CONST.MAP_PARA_HOME_OUT then
    if CHARA:IsExist("HERO") then
      CH("HERO"):SetPosition(SymPos("P_P_HOME_OUT_HERO"))
    elseif CHARA:IsExist("PLAYER") then
      CH("PLAYER"):SetPosition(SymPos("P_P_HOME_OUT_PARTNER"))
    end
    if CHARA:IsExist("PARTNER") then
      CH("PARTNER"):SetPosition(SymPos("P_P_HOME_OUT_PLAYER"))
    end
    MapMoveEnter()
  elseif FLAG.ParaMultiPlay == CONST.FLAG_TRUE and FLAG.MapFrom == CONST.MAP_FROM_NEXTENTRY then
